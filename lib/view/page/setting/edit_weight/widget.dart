...
class EditWeightAppBar extends StatelessWidget implements PreferredSizeWidget {
  const EditWeightAppBar({Key? key}) : super(key: key);
        ...
        GetBuilder<SettingPresenter>(
          builder: (controller) {
            return IconButton(
              ...
              onPressed: controller.weightSubmitted,
            );
          },
        ),
      ],
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    TextFormField(
                      controller: SettingPresenter.weightCont,
                      decoration: InputDecoration(
                        ...
                        suffixIcon: Padding(
                          ...
                          child: Container(
                            ...
                            child: IconButton(
                                onPressed: SettingPresenter.weightCont.clear,
